...
- **tests/test_scripts.py** — 36 dependency-free regression tests covering all three of the above plus the PriceBandScanner tool (`python3 tests/test_scripts.py`, or `py -3 tests\test_scripts.py` on Windows). Run them before committing any script change; expected values were verified against live API data.
